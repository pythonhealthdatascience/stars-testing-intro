# Python example: patient waiting times

This small Python example is used in our HDR UK testing tutorial to show how to test analysis code on patient waiting times.
