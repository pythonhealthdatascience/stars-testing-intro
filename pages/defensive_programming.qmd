...
The first two issues are dealt with using the R `stop()` fucntion. This is called if anything other than a dataframe is passed to the function or raised if the columns (values) of the dataframe are not as expected.
