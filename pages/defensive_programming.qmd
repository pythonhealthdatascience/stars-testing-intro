...
## 1. Protect your code from invalid inputs 

<div class="h3-tight"></div>

Here are some minimal defensive changes we could make to `calculate_wait_times()` 

* Verify that the `df` parameter passed to the function is of type dataframe. 
* Verify that `df` has the expected columns within it.
* Decide how to fail gracefully if either 1 or 2 do not hold.
* If required, provide easy to understand error messages to help a user fix mistakes.
