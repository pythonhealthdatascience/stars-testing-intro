...
```{bash}
#| eval: false
#| file: ../.github/workflows/r_tests.yaml
```
...
* Click on the [python_tests](https://github.com/pythonhealthdatascience/hdruk_tests/actions/workflows/python_tests.yaml) action.
* View the [workflow YAML](https://github.com/pythonhealthdatascience/hdruk_tests/blob/main/.github/workflows/python_tests.yaml).
* Trigger the action via `workflow_dispatch`.
* [View the running test](https://github.com/pythonhealthdatascience/hdruk_tests/actions/runs/21067946032) - see they are installing the requirements, running tests, and pass.

{{< video /videos/run_tests_python_githubactions.webm >}}

The tests all pass in the end-

![](/images/run_tests_python_githubactions.png)
